...
zip -r builds/build.zip . -x ".*" -x "__MACOSX/*" -x "build.zip" -x "build.sh" -x ".git/*" -x ".gitignore" -x "*DS_Store*" -x "web/*" -x "screenshot.png" -x "builds/*"
...
zip -r builds/edge_build.zip . -x ".*" -x "__MACOSX/*" -x "build.zip" -x "build.sh" -x ".git/*" -x ".gitignore" -x "*DS_Store*" -x "web/*" -x "screenshot.png" -x "builds/*"
